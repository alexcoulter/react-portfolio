...
import '../App.css';
 ...
 function Header() {
  ...
  return(
    ...
    <p className="text-center shortBio">I'm a <b>Full Stack Developer</b> from <i>Durham, NC</i> with extensive experience
      in information technology and responsive web development.</p>
